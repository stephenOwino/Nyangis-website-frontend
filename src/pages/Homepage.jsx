...
const carouselImages = [
	...
	"https://m.media-amazon.com/images/I/71ZWMWTEFNL.jpg",
	"https://aboutwallart.com/cdn/shop/products/home-office-artwork-set-of-3-wall-art-prints-578663.jpg?v=1690478820",
];
				...
				>
					...
					{carouselImages.map((image, index) => (
						<img
							...
							className={`absolute top-0 left-0 w-full h-full object-cover object-center transition-opacity duration-1000 ease-in-out bg-gray-200 dark:bg-gray-800 ${
					...
					<button
						...
						className='absolute top-1/2 left-6 transform -translate-y-1/2 bg-blue-900 text-white p-3 rounded-full hover:bg-blue-950 transition-all duration-500'
					>
						<svg
							className='w-6 h-6'
							fill='none'
					...
					<button
						onClick={goToNext}
						className='absolute top-1/2 right-6 transform -translate-y-1/2 bg-blue-900 text-white p-3 rounded-full hover:bg-blue-950 transition-all duration-500'
					>
						<svg
							className='w-6 h-6'
							fill='none'
